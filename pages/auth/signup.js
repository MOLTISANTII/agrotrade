            ...
            <div className="w-full md:w-[420px] flex flex-col gap-3 border border-gray-300 rounded-md p-3">
                ...
                <div className="flex flex-col gap-5 md:gap-3">
                    ...
                    <form>
                        ...
                        <button className="h-[48px] w-full flex justify-center items-center 
                        bg-green-700 text-white text-xl rounded-md">Register</button>
                    </form>
                    ...
                    <div className="flex flex-col gap-3">
                        <button className="h-[48px] flex justify-center items-center border border-slate-400 rounded-md text-slate-800">
                    ...
                    <div className="flex flex-col gap-3">
                        <button className="h-[48px] flex justify-center items-center border border-slate-400 rounded-md text-slate-800">
                        <FaGithub className="text-3xl mr-2"/>Sign up with Github
                        </button>
                    </div>
                </div>
            </div>
